    ...
    return (
      <div className="" id="navbarSupportedContent">
        <ul className="navbar-nav ml-auto">
            ...
            if (isLogined) {
              ...
              return (
                <>
                  ...
                  >
                    <DropdownToggle caret nav id="logout-nav">
                      {name + ' 様'}
                    </DropdownToggle>
                    <DropdownMenu>
                      <DropdownItem
                      ...
                      <DropdownItem onClick={mycartSubmit}>
                        カートを見る
                      </DropdownItem>
                    </DropdownMenu>
                    <Form
              ...
              return (
                <>
                  <li className="nav-item">
                    <Link className="btn btn-danger mr-3" to={Url.LOGIN}>
                      ログイン
                    </Link>
                  </li>
                  <li className="nav-item">
          ...
          <li className="nav-item">
            <Link className="btn btn-link text-danger" to={Url.CONTACT}>
              お問い合わせ
            </Link>
          </li>
        </ul>

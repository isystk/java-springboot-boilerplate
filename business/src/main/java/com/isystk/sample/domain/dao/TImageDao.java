...
public interface TImageDao {
    ...
    <R> R selectAll(final TImageCriteria criteria, final SelectOptions options, final Collector<TImage, ?, R> collector);
     ...
     */
    @Select
    Optional<TImage> select(TImageCriteria criteria);

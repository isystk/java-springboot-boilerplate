...
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-24T01:32:46.438+0900")
public class TStaffDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements com.isystk.sample.domain.dao.TStaffDao {
    ...
    private static final java.lang.reflect.Method __method0 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "selectById", java.lang.Integer.class);

    private static final java.lang.reflect.Method __method1 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "selectByIdAndVersion", java.lang.Integer.class, java.lang.Long.class);

    private static final java.lang.reflect.Method __method2 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "insert", com.isystk.sample.domain.entity.TStaff.class);

    private static final java.lang.reflect.Method __method3 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "update", com.isystk.sample.domain.entity.TStaff.class);

    private static final java.lang.reflect.Method __method4 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "delete", com.isystk.sample.domain.entity.TStaff.class);

    private static final java.lang.reflect.Method __method5 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "selectAll", com.isystk.sample.domain.dto.staff.StaffCriteria.class, org.seasar.doma.jdbc.SelectOptions.class, java.util.stream.Collector.class);

    private static final java.lang.reflect.Method __method6 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "selectById", java.lang.Long.class);

    private static final java.lang.reflect.Method __method7 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TStaffDao.class, "select", com.isystk.sample.domain.dto.staff.StaffCriteria.class);
    ...
    @Override
    public com.isystk.sample.domain.entity.TStaff selectById(java.lang.Integer staffId) {
    ...
    public com.isystk.sample.domain.entity.TStaff selectByIdAndVersion(java.lang.Integer staffId, java.lang.Long version) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<com.isystk.sample.domain.entity.TStaff> __command = getCommandImplementors().createSelectCommand(__method1, __query, new org.seasar.doma.internal.jdbc.command.EntitySingleResultHandler<com.isystk.sample.domain.entity.TStaff>(com.isystk.sample.domain.entity._TStaff.getSingletonInternal()));
            com.isystk.sample.domain.entity.TStaff __result = __command.execute();
            __query.complete();
    ...
    public int insert(com.isystk.sample.domain.entity.TStaff entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoInsertQuery<com.isystk.sample.domain.entity.TStaff> __query = getQueryImplementors().createAutoInsertQuery(__method2, com.isystk.sample.domain.entity._TStaff.getSingletonInternal());
    ...
    public int update(com.isystk.sample.domain.entity.TStaff entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoUpdateQuery<com.isystk.sample.domain.entity.TStaff> __query = getQueryImplementors().createAutoUpdateQuery(__method3, com.isystk.sample.domain.entity._TStaff.getSingletonInternal());
    ...
    public int delete(com.isystk.sample.domain.entity.TStaff entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoDeleteQuery<com.isystk.sample.domain.entity.TStaff> __query = getQueryImplementors().createAutoDeleteQuery(__method4, com.isystk.sample.domain.entity._TStaff.getSingletonInternal());
    ...
    @Override
    public <R> R selectAll(com.isystk.sample.domain.dto.staff.StaffCriteria criteria, org.seasar.doma.jdbc.SelectOptions options, java.util.stream.Collector<com.isystk.sample.domain.entity.TStaff, ?, R> collector) {
        ...
        try {
            ...
            __query.setEntityType(com.isystk.sample.domain.entity._TStaff.getSingletonInternal());
            __query.addParameter("criteria", com.isystk.sample.domain.dto.staff.StaffCriteria.class, criteria);
            __query.setCallerClassName("com.isystk.sample.domain.dao.TStaffDaoImpl");
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<R> __command = getCommandImplementors().createSelectCommand(__method5, __query, new org.seasar.doma.internal.jdbc.command.EntityCollectorHandler<com.isystk.sample.domain.entity.TStaff, R>(com.isystk.sample.domain.entity._TStaff.getSingletonInternal(), collector));
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TStaff> select(com.isystk.sample.domain.dto.staff.StaffCriteria criteria) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<java.util.Optional<com.isystk.sample.domain.entity.TStaff>> __command = getCommandImplementors().createSelectCommand(__method7, __query, new org.seasar.doma.internal.jdbc.command.OptionalEntitySingleResultHandler<com.isystk.sample.domain.entity.TStaff>(com.isystk.sample.domain.entity._TStaff.getSingletonInternal()));
            java.util.Optional<com.isystk.sample.domain.entity.TStaff> __result = __command.execute();
            __query.complete();

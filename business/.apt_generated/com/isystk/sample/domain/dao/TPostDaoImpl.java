...
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-24T15:31:07.801+0900")
public class TPostDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements com.isystk.sample.domain.dao.TPostDao {
    ...
    private static final java.lang.reflect.Method __method5 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "selectAll", com.isystk.sample.domain.dto.PostCriteria.class, org.seasar.doma.jdbc.SelectOptions.class, java.util.stream.Collector.class);

    private static final java.lang.reflect.Method __method6 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "selectById", java.lang.Long.class);

    private static final java.lang.reflect.Method __method7 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "select", com.isystk.sample.domain.dto.PostCriteria.class);
    ...
    public <R> R selectAll(com.isystk.sample.domain.dto.PostCriteria criteria, org.seasar.doma.jdbc.SelectOptions options, java.util.stream.Collector<com.isystk.sample.domain.entity.TPost, ?, R> collector) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<R> __command = getCommandImplementors().createSelectCommand(__method5, __query, new org.seasar.doma.internal.jdbc.command.EntityCollectorHandler<com.isystk.sample.domain.entity.TPost, R>(com.isystk.sample.domain.entity._TPost.getSingletonInternal(), collector));
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TPost> selectById(java.lang.Long postId) {
        entering("com.isystk.sample.domain.dao.TPostDaoImpl", "selectById", postId);
        try {
            ...
            __query.setSqlFilePath("META-INF/com/isystk/sample/domain/dao/TPostDao/selectById.sql");
            __query.setEntityType(com.isystk.sample.domain.entity._TPost.getSingletonInternal());
            __query.addParameter("postId", java.lang.Long.class, postId);
            __query.setCallerClassName("com.isystk.sample.domain.dao.TPostDaoImpl");
            __query.setCallerMethodName("selectById");
            __query.setResultEnsured(false);
            __query.setResultMappingEnsured(false);
    ...
    public java.util.Optional<com.isystk.sample.domain.entity.TPost> select(com.isystk.sample.domain.dto.PostCriteria criteria) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<java.util.Optional<com.isystk.sample.domain.entity.TPost>> __command = getCommandImplementors().createSelectCommand(__method7, __query, new org.seasar.doma.internal.jdbc.command.OptionalEntitySingleResultHandler<com.isystk.sample.domain.entity.TPost>(com.isystk.sample.domain.entity._TPost.getSingletonInternal()));
            java.util.Optional<com.isystk.sample.domain.entity.TPost> __result = __command.execute();
            __query.complete();

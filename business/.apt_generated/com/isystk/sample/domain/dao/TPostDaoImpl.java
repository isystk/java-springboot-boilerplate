...
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-29T01:38:38.209+0900")
public class TPostDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements com.isystk.sample.domain.dao.TPostDao {
    ...
    private static final java.lang.reflect.Method __method0 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "insert", com.isystk.sample.domain.entity.TPost.class);

    private static final java.lang.reflect.Method __method1 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "update", com.isystk.sample.domain.entity.TPost.class);

    private static final java.lang.reflect.Method __method2 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "delete", com.isystk.sample.domain.entity.TPost.class);

    private static final java.lang.reflect.Method __method3 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "selectAll", com.isystk.sample.domain.dto.TPostCriteria.class, org.seasar.doma.jdbc.SelectOptions.class, java.util.stream.Collector.class);

    private static final java.lang.reflect.Method __method4 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "selectById", java.lang.Integer.class);

    private static final java.lang.reflect.Method __method5 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "selectByIdAndVersion", java.lang.Integer.class, java.lang.Long.class);

    private static final java.lang.reflect.Method __method6 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TPostDao.class, "select", com.isystk.sample.domain.dto.TPostCriteria.class);
    ...
    public int insert(com.isystk.sample.domain.entity.TPost entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoInsertQuery<com.isystk.sample.domain.entity.TPost> __query = getQueryImplementors().createAutoInsertQuery(__method0, com.isystk.sample.domain.entity._TPost.getSingletonInternal());
    ...
    public int update(com.isystk.sample.domain.entity.TPost entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoUpdateQuery<com.isystk.sample.domain.entity.TPost> __query = getQueryImplementors().createAutoUpdateQuery(__method1, com.isystk.sample.domain.entity._TPost.getSingletonInternal());
    ...
    public int delete(com.isystk.sample.domain.entity.TPost entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoDeleteQuery<com.isystk.sample.domain.entity.TPost> __query = getQueryImplementors().createAutoDeleteQuery(__method2, com.isystk.sample.domain.entity._TPost.getSingletonInternal());
    ...
    @Override
    public <R> R selectAll(com.isystk.sample.domain.dto.TPostCriteria criteria, org.seasar.doma.jdbc.SelectOptions options, java.util.stream.Collector<com.isystk.sample.domain.entity.TPost, ?, R> collector) {
        ...
        try {
            ...
            __query.addParameter("criteria", com.isystk.sample.domain.dto.TPostCriteria.class, criteria);
            __query.setCallerClassName("com.isystk.sample.domain.dao.TPostDaoImpl");
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<R> __command = getCommandImplementors().createSelectCommand(__method3, __query, new org.seasar.doma.internal.jdbc.command.EntityCollectorHandler<com.isystk.sample.domain.entity.TPost, R>(com.isystk.sample.domain.entity._TPost.getSingletonInternal(), collector));
    ...
    public java.util.Optional<com.isystk.sample.domain.entity.TPost> selectById(java.lang.Integer postId) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<java.util.Optional<com.isystk.sample.domain.entity.TPost>> __command = getCommandImplementors().createSelectCommand(__method4, __query, new org.seasar.doma.internal.jdbc.command.OptionalEntitySingleResultHandler<com.isystk.sample.domain.entity.TPost>(com.isystk.sample.domain.entity._TPost.getSingletonInternal()));
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TPost> selectByIdAndVersion(java.lang.Integer postId, java.lang.Long version) {
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TPost> select(com.isystk.sample.domain.dto.TPostCriteria criteria) {

...
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-29T20:24:57.481+0900")
public class TUserDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements com.isystk.sample.domain.dao.TUserDao {
    ...
    private static final java.lang.reflect.Method __method0 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "insert", com.isystk.sample.domain.entity.TUser.class);

    private static final java.lang.reflect.Method __method1 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "update", com.isystk.sample.domain.entity.TUser.class);

    private static final java.lang.reflect.Method __method2 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "delete", com.isystk.sample.domain.entity.TUser.class);

    private static final java.lang.reflect.Method __method3 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "selectAll", com.isystk.sample.domain.dto.TUserCriteria.class, org.seasar.doma.jdbc.SelectOptions.class, java.util.stream.Collector.class);

    private static final java.lang.reflect.Method __method4 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "selectById", java.lang.Integer.class);

    private static final java.lang.reflect.Method __method5 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "selectByIdAndVersion", java.lang.Integer.class, java.lang.Long.class);

    private static final java.lang.reflect.Method __method6 = org.seasar.doma.internal.jdbc.dao.AbstractDao.getDeclaredMethod(com.isystk.sample.domain.dao.TUserDao.class, "select", com.isystk.sample.domain.dto.TUserCriteria.class);
    ...
    public int insert(com.isystk.sample.domain.entity.TUser entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoInsertQuery<com.isystk.sample.domain.entity.TUser> __query = getQueryImplementors().createAutoInsertQuery(__method0, com.isystk.sample.domain.entity._TUser.getSingletonInternal());
    ...
    public int update(com.isystk.sample.domain.entity.TUser entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoUpdateQuery<com.isystk.sample.domain.entity.TUser> __query = getQueryImplementors().createAutoUpdateQuery(__method1, com.isystk.sample.domain.entity._TUser.getSingletonInternal());
    ...
    public int delete(com.isystk.sample.domain.entity.TUser entity) {
        ...
        try {
            ...
            org.seasar.doma.jdbc.query.AutoDeleteQuery<com.isystk.sample.domain.entity.TUser> __query = getQueryImplementors().createAutoDeleteQuery(__method2, com.isystk.sample.domain.entity._TUser.getSingletonInternal());
    ...
    @Override
    public <R> R selectAll(com.isystk.sample.domain.dto.TUserCriteria criteria, org.seasar.doma.jdbc.SelectOptions options, java.util.stream.Collector<com.isystk.sample.domain.entity.TUser, ?, R> collector) {
        ...
        try {
            ...
            __query.addParameter("criteria", com.isystk.sample.domain.dto.TUserCriteria.class, criteria);
            __query.setCallerClassName("com.isystk.sample.domain.dao.TUserDaoImpl");
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<R> __command = getCommandImplementors().createSelectCommand(__method3, __query, new org.seasar.doma.internal.jdbc.command.EntityCollectorHandler<com.isystk.sample.domain.entity.TUser, R>(com.isystk.sample.domain.entity._TUser.getSingletonInternal(), collector));
    ...
    public java.util.Optional<com.isystk.sample.domain.entity.TUser> selectById(java.lang.Integer userId) {
        ...
        try {
            ...
            __query.setSqlLogType(org.seasar.doma.jdbc.SqlLogType.FORMATTED);
            __query.prepare();
            org.seasar.doma.jdbc.command.SelectCommand<java.util.Optional<com.isystk.sample.domain.entity.TUser>> __command = getCommandImplementors().createSelectCommand(__method4, __query, new org.seasar.doma.internal.jdbc.command.OptionalEntitySingleResultHandler<com.isystk.sample.domain.entity.TUser>(com.isystk.sample.domain.entity._TUser.getSingletonInternal()));
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TUser> selectByIdAndVersion(java.lang.Integer userId, java.lang.Long version) {
    ...
    @Override
    public java.util.Optional<com.isystk.sample.domain.entity.TUser> select(com.isystk.sample.domain.dto.TUserCriteria criteria) {

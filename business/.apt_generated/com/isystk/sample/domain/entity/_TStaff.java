...
/** */
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-24T15:30:58.681+0900")
public final class _TStaff extends org.seasar.doma.jdbc.entity.AbstractEntityType<com.isystk.sample.domain.entity.TStaff> {
    ...
    /** the lastLoginTime */
    public final org.seasar.doma.jdbc.entity.DefaultPropertyType<com.isystk.sample.domain.entity.TStaff, java.sql.Timestamp, java.sql.Timestamp> $lastLoginTime = new org.seasar.doma.jdbc.entity.DefaultPropertyType<>(com.isystk.sample.domain.entity.TStaff.class, () -> new org.seasar.doma.internal.jdbc.scalar.BasicScalar<>(org.seasar.doma.wrapper.TimestampWrapper::new), "lastLoginTime", "LAST_LOGIN_TIME", __namingType, true, true, false);

    /** the registTime */
    public final org.seasar.doma.jdbc.entity.DefaultPropertyType<com.isystk.sample.domain.entity.TStaff, java.sql.Timestamp, java.sql.Timestamp> $registTime = new org.seasar.doma.jdbc.entity.DefaultPropertyType<>(com.isystk.sample.domain.entity.TStaff.class, () -> new org.seasar.doma.internal.jdbc.scalar.BasicScalar<>(org.seasar.doma.wrapper.TimestampWrapper::new), "registTime", "REGIST_TIME", __namingType, true, true, false);

    /** the updateTime */
    public final org.seasar.doma.jdbc.entity.DefaultPropertyType<com.isystk.sample.domain.entity.TStaff, java.sql.Timestamp, java.sql.Timestamp> $updateTime = new org.seasar.doma.jdbc.entity.DefaultPropertyType<>(com.isystk.sample.domain.entity.TStaff.class, () -> new org.seasar.doma.internal.jdbc.scalar.BasicScalar<>(org.seasar.doma.wrapper.TimestampWrapper::new), "updateTime", "UPDATE_TIME", __namingType, true, true, false);
    ...
    private final java.util.function.Supplier<com.isystk.sample.domain.entity.TStaffListener> __listenerSupplier;
    ...
    public void preInsert(com.isystk.sample.domain.entity.TStaff entity, org.seasar.doma.jdbc.entity.PreInsertContext<com.isystk.sample.domain.entity.TStaff> context) {
        Class __listenerClass = com.isystk.sample.domain.entity.TStaffListener.class;
        com.isystk.sample.domain.entity.TStaffListener __listener = context.getConfig().getEntityListenerProvider().get(__listenerClass, __listenerSupplier);
    ...
    private static class ListenerHolder {
        private static com.isystk.sample.domain.entity.TStaffListener listener = new com.isystk.sample.domain.entity.TStaffListener();
    }

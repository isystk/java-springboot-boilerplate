...
/** */
@javax.annotation.Generated(value = { "Doma", "2.27.1" }, date = "2020-03-24T15:30:59.824+0900")
public final class _TUserOnetimePass extends org.seasar.doma.jdbc.entity.AbstractEntityType<com.isystk.sample.domain.entity.TUserOnetimePass> {
    ...
    public final org.seasar.doma.jdbc.entity.DefaultPropertyType<com.isystk.sample.domain.entity.TUserOnetimePass, java.sql.Timestamp, java.sql.Timestamp> $onetimeValidTime = new org.seasar.doma.jdbc.entity.DefaultPropertyType<>(com.isystk.sample.domain.entity.TUserOnetimePass.class, () -> new org.seasar.doma.internal.jdbc.scalar.BasicScalar<>(org.seasar.doma.wrapper.TimestampWrapper::new), "onetimeValidTime", "ONETIME_VALID_TIME", __namingType, true, true, false);

    private final java.util.function.Supplier<com.isystk.sample.domain.entity.TUserOnetimePassListener> __listenerSupplier;
    ...
    private _TUserOnetimePass() {
        ...
        java.util.List<org.seasar.doma.jdbc.entity.EntityPropertyType<com.isystk.sample.domain.entity.TUserOnetimePass, ?>> __list = new java.util.ArrayList<>(3);
        java.util.Map<String, org.seasar.doma.jdbc.entity.EntityPropertyType<com.isystk.sample.domain.entity.TUserOnetimePass, ?>> __map = new java.util.HashMap<>(3);
        __idList.add($userId);
        __list.add($userId);
    ...
    public void preInsert(com.isystk.sample.domain.entity.TUserOnetimePass entity, org.seasar.doma.jdbc.entity.PreInsertContext<com.isystk.sample.domain.entity.TUserOnetimePass> context) {
        Class __listenerClass = com.isystk.sample.domain.entity.TUserOnetimePassListener.class;
        com.isystk.sample.domain.entity.TUserOnetimePassListener __listener = context.getConfig().getEntityListenerProvider().get(__listenerClass, __listenerSupplier);
    ...
    private static class ListenerHolder {
        private static com.isystk.sample.domain.entity.TUserOnetimePassListener listener = new com.isystk.sample.domain.entity.TUserOnetimePassListener();
    }
